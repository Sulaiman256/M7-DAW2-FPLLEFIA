...
<body>
    <div class="container mt-5">
        <div class="row">
          ...
          <button class="btn btn-outline-info">'.$detallesPelicula['horario_array'][0].'</button>
          <button class="btn btn-outline-info">'.$detallesPelicula['horario_array'][1].'</button>
          <button class="btn btn-outline-info">'.$detallesPelicula['horario_array'][2].'</button>
          <button class="btn btn-outline-info">'.$detallesPelicula['horario_array'][3].'</button>
