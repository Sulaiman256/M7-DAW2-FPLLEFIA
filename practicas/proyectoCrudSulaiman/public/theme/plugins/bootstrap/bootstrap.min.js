! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.Popper = e() }(this, function() {
    ...
    function e(t, e) { if (1 !== t.nodeType) return []; var n = getComputedStyle(t, null); return e ? n[e] : n }
    ...
    function r(t) { return 11 === t ? K : 10 === t ? V : K || V }

    function o(t) { if (!t) return document.documentElement; for (var n = r(10) ? document.body : null, i = t.offsetParent; i === n && t.nextElementSibling;) i = (t = t.nextElementSibling).offsetParent; var s = i && i.nodeName; return s && "BODY" !== s && "HTML" !== s ? -1 !== ["TD", "TABLE"].indexOf(i.nodeName) && "static" === e(i, "position") ? o(i) : i : t ? t.ownerDocument.documentElement : document.documentElement }
    ...
    function h(t, e, n, i) { return H(e["offset" + t], e["scroll" + t], n["client" + t], n["offset" + t], n["scroll" + t], r(10) ? n["offset" + t] + i["margin" + ("Height" === t ? "Top" : "Left")] + i["margin" + ("Height" === t ? "Bottom" : "Right")] : 0) }
    ...
    function u(t) { return q({}, t, { right: t.left + t.width, bottom: t.top + t.height }) }
    ...
    function g(t) { if (!t || !t.parentElement || r()) return document.documentElement; for (var n = t.parentElement; n && "none" === e(n, "transform");) n = n.parentElement; return n || document.documentElement }
    ...
    function m(t, r, o, s) {
        ...
        if ("viewport" === s) h = function(t) {
            ...
            var _ = p(m, d, c);
            if ("HTML" !== m.nodeName || function t(i) { var r = i.nodeName; return "BODY" !== r && "HTML" !== r && ("fixed" === e(i, "position") || t(n(i))) }(d)) h = _;
            else {
                var v = f(),
                    E = v.height,
                    y = v.width;
    ...
    function _(t, e, n, i, r) {
        ...
        var s = m(n, i, o, r),
            ...
            l = Object.keys(a).map(function(t) { return q({ key: t }, a[t], { area: (e = a[t], e.width * e.height) }); var e }).sort(function(t, e) { return e.area - t.area }),
    ...
    function v(t, e, n) { var i = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : null; return p(n, i ? g(e) : a(e, n), i) }
    ...
    function C(e, n, i) {
        return (void 0 === i ? e : e.slice(0, function(t, e, n) { if (Array.prototype.findIndex) return t.findIndex(function(t) { return t[e] === n }); var i = T(t, function(t) { return t[e] === n }); return t.indexOf(i) }(e, "name", i))).forEach(function(e) {
    ...
    function S() {
        var t, e;
        this.state.eventsEnabled && (cancelAnimationFrame(this.scheduleUpdate), this.state = (t = this.reference, e = this.state, D(t).removeEventListener("resize", e.updateBound), e.scrollParents.forEach(function(t) { t.removeEventListener("scroll", e.updateBound) }), e.updateBound = null, e.scrollParents = [], e.scrollElement = null, e.eventsEnabled = !1, e))
    }

    function O(t) { return "" !== t && !isNaN(parseFloat(t)) && isFinite(t) }

    function N(t, e) { Object.keys(e).forEach(function(n) { var i = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && O(e[n]) && (i = "px"), t.style[n] = e[n] + i }) }
    ...
    function P(t, e, n, i) {
        var r = [0, 0],
            ...
            a = s.indexOf(T(s, function(t) { return -1 !== t.search(/,|\s/) }));
        ...
        })).forEach(function(t, e) { t.forEach(function(n, i) { O(n) && (r[e] += n * ("-" === t[i - 1] ? -1 : 1)) }) }), r
    }
    for (var x = Math.min, j = Math.round, R = Math.floor, H = Math.max, F = "undefined" != typeof window && "undefined" != typeof document, W = ["Edge", "Trident", "Firefox"], M = 0, U = 0; U < W.length; U += 1)
        if (F && 0 <= navigator.userAgent.indexOf(W[U])) { M = 1; break }
    var B = F && window.Promise ? function(t) { var e = !1; return function() { e || (e = !0, window.Promise.resolve().then(function() { e = !1, t() })) } } : function(t) { var e = !1; return function() { e || (e = !0, setTimeout(function() { e = !1, t() }, M)) } },
        ...
        tt = function() {
            ...
            }, { key: "destroy", value: function() { return function() { return this.state.isDestroyed = !0, w(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"), this.popper.style.position = "", this.popper.style.top = "", this.popper.style.left = "", this.popper.style.right = "", this.popper.style.bottom = "", this.popper.style.willChange = "", this.popper.style[I("transform")] = ""), this.disableEventListeners(), this.options.removeOnDestroy && this.popper.parentNode.removeChild(this.popper), this }.call(this) } }, { key: "enableEventListeners", value: function() { return function() { this.state.eventsEnabled || (this.state = A(this.reference, this.options, this.state, this.scheduleUpdate)) }.call(this) } }, { key: "disableEventListeners", value: function() { return S.call(this) } }]), e
        }();
    return tt.Utils = ("undefined" == typeof window ? global : window).PopperUtils, tt.placements = z, tt.Defaults = {
        ...
        modifiers: {
            ...
            preventOverflow: {
                ...
                fn: function(t, e) {
                    ...
                    var h = e.priority,
                        f = t.offsets.popper,
                        u = {
                            primary: function(t) { var n = f[t]; return f[t] < c[t] && !e.escapeWithReference && (n = H(f[t], c[t])), G({}, t, n) },
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    var n = e.x,
                        i = e.y,
                        r = t.offsets.popper,
                        s = T(t.instance.modifiers, function(t) { return "applyStyle" === t.name }).gpuAcceleration;
            ...
            applyStyle: {
                order: 900,
                enabled: !0,
                fn: function(t) { return N(t.instance.popper, t.styles), e = t.instance.popper, n = t.attributes, Object.keys(n).forEach(function(t) {!1 === n[t] ? e.removeAttribute(t) : e.setAttribute(t, n[t]) }), t.arrowElement && Object.keys(t.arrowStyles).length && N(t.arrowElement, t.arrowStyles), t; var e, n },
    ...
    var s, a, l, c, h, f, u, d, p, g, m, _, v, E, y, b, T, C, w, I, D, A, S, O, N, k, L, P, x, j, R, H, F, W, M, U, B, K, V, Q, Y, G, q, z, X, J, Z, $, tt, et, nt, it, rt, ot, st, at, lt, ct, ht, ft, ut, dt, pt, gt, mt, _t, vt, Et, yt, bt, Tt, Ct, wt, It, Dt, At, St, Ot, Nt, kt, Lt, Pt, xt, jt, Rt, Ht, Ft, Wt, Mt, Ut, Bt, Kt, Vt, Qt, Yt, Gt, qt, zt, Xt, Jt, Zt, $t, te, ee, ne, ie, re, oe, se, ae, le, ce, he, fe, ue, de, pe, ge, me, _e, ve, Ee, ye, be, Te, Ce, we, Ie, De, Ae, Se, Oe, Ne, ke, Le, Pe, xe, je, Re, He, Fe, We, Me, Ue, Be, Ke, Ve, Qe, Ye, Ge, qe, ze, Xe, Je, Ze, $e, tn, en, nn, rn = function(t) {
            ...
            var n = {
                ...
                getSelectorFromElement: function(e) {
                    ...
                    try { return 0 < t(document).find(n).length ? n : null } catch (e) { return null }
                },
                getTransitionDurationFromElement: function(e) { if (!e) return 0; var n = t(e).css("transition-duration"); return parseFloat(n) ? (n = n.split(",")[0], 1e3 * parseFloat(n)) : 0 },
            ...
            return t.fn.emulateTransitionEnd = function(e) {
                var i = this,
                    r = !1;
                return t(this).one(n.TRANSITION_END, function() { r = !0 }), setTimeout(function() { r || n.triggerTransitionEnd(i) }, e), this
            }, t.event.special[n.TRANSITION_END] = { bindType: e, delegateType: e, handle: function(e) { if (t(e.target).is(this)) return e.handleObj.handler.apply(this, arguments) } }, n
        }(e),
        on = (a = "alert", c = "." + (l = "bs.alert"), h = (s = e).fn[a], f = { CLOSE: "close" + c, CLOSED: "closed" + c, CLICK_DATA_API: "click" + c + ".data-api" }, "alert", "fade", "show", u = function() {
            ...
            }, e._triggerCloseEvent = function(t) { var e = s.Event(f.CLOSE); return s(t).trigger(e), e }, e._removeElement = function(t) {
                var e = this;
                if (s(t).removeClass("show"), s(t).hasClass("fade")) {
                    var n = rn.getTransitionDurationFromElement(t);
                    s(t).one(rn.TRANSITION_END, function(n) { return e._destroyElement(t, n) }).emulateTransitionEnd(n)
                } else this._destroyElement(t)
            }, e._destroyElement = function(t) { s(t).detach().trigger(f.CLOSED).remove() }, t._jQueryInterface = function(e) {
                return this.each(function() {
                    var n = s(this),
                        i = n.data(l);
                    i || (i = new t(this), n.data(l, i)), "close" === e && i[e](this)
                })
            }, t._handleDismiss = function(t) { return function(e) { e && e.preventDefault(), t.close(this) } }, r(t, null, [{ key: "VERSION", get: function() { return "4.1.1" } }]), t
        }(), s(document).on(f.CLICK_DATA_API, '[data-dismiss="alert"]', u._handleDismiss(new u)), s.fn[a] = u._jQueryInterface, s.fn[a].Constructor = u, s.fn[a].noConflict = function() { return s.fn[a] = h, u._jQueryInterface }, u),
        sn = (p = "button", m = "." + (g = "bs.button"), _ = ".data-api", v = (d = e).fn[p], E = "active", "btn", y = '[data-toggle^="button"]', b = '[data-toggle="buttons"]', "input", T = ".active", C = ".btn", w = { CLICK_DATA_API: "click" + m + _, FOCUS_BLUR_DATA_API: "focus" + m + _ + " blur" + m + _ }, I = function() {
            function t(t) { this._element = t }
            var e = t.prototype;
            ...
            }, e.dispose = function() { d.removeData(this._element, g), this._element = null }, t._jQueryInterface = function(e) {
                return this.each(function() {
                    var n = d(this).data(g);
                    n || (n = new t(this), d(this).data(g, n)), "toggle" === e && n[e]()
                })
            }, r(t, null, [{ key: "VERSION", get: function() { return "4.1.1" } }]), t
        ...
        }), d.fn[p] = I._jQueryInterface, d.fn[p].Constructor = I, d.fn[p].noConflict = function() { return d.fn[p] = v, I._jQueryInterface }, I),
        an = (A = "carousel", O = "." + (S = "bs.carousel"), N = ".data-api", k = (D = e).fn[A], L = { interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0 }, P = { interval: "(number|boolean)", keyboard: "boolean", slide: "(boolean|string)", pause: "(string|boolean)", wrap: "boolean" }, x = "next", j = "prev", "left", "right", R = { SLIDE: "slide" + O, SLID: "slid" + O, KEYDOWN: "keydown" + O, MOUSEENTER: "mouseenter" + O, MOUSELEAVE: "mouseleave" + O, TOUCHEND: "touchend" + O, LOAD_DATA_API: "load" + O + N, CLICK_DATA_API: "click" + O + N }, H = "carousel", F = "active", "slide", W = "carousel-item-right", M = "carousel-item-left", U = "carousel-item-next", B = "carousel-item-prev", K = { ACTIVE: ".active", ACTIVE_ITEM: ".active.carousel-item", ITEM: ".carousel-item", NEXT_PREV: ".carousel-item-next, .carousel-item-prev", INDICATORS: ".carousel-indicators", DATA_SLIDE: "[data-slide], [data-slide-to]", DATA_RIDE: '[data-ride="carousel"]' }, V = function() {
            function t(t, e) { this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(e), this._element = D(t)[0], this._indicatorsElement = D(this._element).find(K.INDICATORS)[0], this._addEventListeners() }
            var e = t.prototype;
            return e.next = function() { this._isSliding || this._slide(x) }, e.nextWhenVisible = function() {!document.hidden && D(this._element).is(":visible") && "hidden" !== D(this._element).css("visibility") && this.next() }, e.prev = function() { this._isSliding || this._slide(j) }, e.pause = function(t) { t || (this._isPaused = !0), D(this._element).find(K.NEXT_PREV)[0] && (rn.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null }, e.cycle = function(t) { t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval)) }, e.to = function(t) {
                var e = this;
                this._activeElement = D(this._element).find(K.ACTIVE_ITEM)[0];
                var n = this._getItemIndex(this._activeElement);
                if (!(t > this._items.length - 1 || t < 0))
                    if (this._isSliding) D(this._element).one(R.SLID, function() { return e.to(t) });
                    else {
                        if (n === t) return this.pause(), void this.cycle();
                        var i = n < t ? x : j;
                        this._slide(i, this._items[t])
                    }
            }, e.dispose = function() { D(this._element).off(O), D.removeData(this._element, S), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null }, e._getConfig = function(t) { return t = o({}, L, t), rn.typeCheckConfig(A, t, P), t }, e._addEventListeners = function() {
                var t = this;
                this._config.keyboard && D(this._element).on(R.KEYDOWN, function(e) { return t._keydown(e) }), "hover" === this._config.pause && (D(this._element).on(R.MOUSEENTER, function(e) { return t.pause(e) }).on(R.MOUSELEAVE, function(e) { return t.cycle(e) }), "ontouchstart" in document.documentElement && D(this._element).on(R.TOUCHEND, function() { t.pause(), t.touchTimeout && clearTimeout(t.touchTimeout), t.touchTimeout = setTimeout(function(e) { return t.cycle(e) }, 500 + t._config.interval) }))
            ...
            }, e._getItemIndex = function(t) { return this._items = D.makeArray(D(t).parent().find(K.ITEM)), this._items.indexOf(t) }, e._getItemByDirection = function(t, e) {
                var n = t === x,
                    i = t === j,
                ...
                if (t === x ? (n = M, i = U, r = "left") : (n = W, i = B, r = "right"), l && D(l).hasClass(F)) this._isSliding = !1;
                    ...
                    if (D(this._element).hasClass("slide")) {
                        ...
                        D(s).one(rn.TRANSITION_END, function() { D(l).removeClass(n + " " + i).addClass(F), D(s).removeClass(F + " " + i + " " + n), o._isSliding = !1, setTimeout(function() { return D(o._element).trigger(f) }, 0) }).emulateTransitionEnd(u)
            ...
            }, r(t, null, [{ key: "VERSION", get: function() { return "4.1.1" } }, { key: "Default", get: function() { return L } }]), t
        ...
        }), D.fn[A] = V._jQueryInterface, D.fn[A].Constructor = V, D.fn[A].noConflict = function() { return D.fn[A] = k, V._jQueryInterface }, V),
        ln = (Y = "collapse", q = "." + (G = "bs.collapse"), z = (Q = e).fn[Y], X = { toggle: !0, parent: "" }, J = { toggle: "boolean", parent: "(string|element)" }, Z = { SHOW: "show" + q, SHOWN: "shown" + q, HIDE: "hide" + q, HIDDEN: "hidden" + q, CLICK_DATA_API: "click" + q + ".data-api" }, $ = "show", tt = "collapse", et = "collapsing", nt = "collapsed", it = "width", "height", rt = { ACTIVES: ".show, .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]' }, ot = function() {
            function t(t, e) {
            ...
            var e = t.prototype;
            return e.toggle = function() { Q(this._element).hasClass($) ? this.hide() : this.show() }, e.show = function() {
                var e, n, i = this;
                if (!(this._isTransitioning || Q(this._element).hasClass($) || (this._parent && 0 === (e = Q.makeArray(Q(this._parent).find(rt.ACTIVES).filter('[data-parent="' + this._config.parent + '"]'))).length && (e = null), e && (n = Q(e).not(this._selector).data(G)) && n._isTransitioning))) {
                    ...
                    if (Q(this._element).trigger(r), !r.isDefaultPrevented()) {
                        ...
                        Q(this._element).one(rn.TRANSITION_END, function() { Q(i._element).removeClass(et).addClass(tt).addClass($), i._element.style[o] = "", i.setTransitioning(!1), Q(i._element).trigger(Z.SHOWN) }).emulateTransitionEnd(a), this._element.style[o] = this._element[s] + "px"
                    }
                }
            }, e.hide = function() {
                var t = this;
                if (!this._isTransitioning && Q(this._element).hasClass($)) {
                    ...
                    if (Q(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        Q(this._element).one(rn.TRANSITION_END, function() { t.setTransitioning(!1), Q(t._element).removeClass(et).addClass(tt).trigger(Z.HIDDEN) }).emulateTransitionEnd(s)
                    }
                }
            }, e.setTransitioning = function(t) { this._isTransitioning = t }, e.dispose = function() { Q.removeData(this._element, G), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null }, e._getConfig = function(t) { return (t = o({}, X, t)).toggle = Boolean(t.toggle), rn.typeCheckConfig(Y, t, J), t }, e._getDimension = function() { return Q(this._element).hasClass(it) ? it : "height" }, e._getParent = function() {
                var e = this,
                    n = null;
                ...
                return Q(n).find(i).each(function(n, i) { e._addAriaAndCollapsedClass(t._getTargetFromElement(i), [i]) }), n
            }, e._addAriaAndCollapsedClass = function(t, e) {
                if (t) {
                    var n = Q(t).hasClass($);
                    0 < e.length && Q(e).toggleClass(nt, !n).attr("aria-expanded", n)
                }
            }, t._getTargetFromElement = function(t) { var e = rn.getSelectorFromElement(t); return e ? Q(e)[0] : null }, t._jQueryInterface = function(e) {
                return this.each(function() {
                    var n = Q(this),
                        i = n.data(G),
            ...
            }, r(t, null, [{ key: "VERSION", get: function() { return "4.1.1" } }, { key: "Default", get: function() { return X } }]), t
        ...
        }), Q.fn[Y] = ot._jQueryInterface, Q.fn[Y].Constructor = ot, Q.fn[Y].noConflict = function() { return Q.fn[Y] = z, ot._jQueryInterface }, ot),
        cn = (at = "dropdown", ct = "." + (lt = "bs.dropdown"), ht = ".data-api", ft = (st = e).fn[at], ut = new RegExp("38|40|27"), dt = { HIDE: "hide" + ct, HIDDEN: "hidden" + ct, SHOW: "show" + ct, SHOWN: "shown" + ct, CLICK: "click" + ct, CLICK_DATA_API: "click" + ct + ht, KEYDOWN_DATA_API: "keydown" + ct + ht, KEYUP_DATA_API: "keyup" + ct + ht }, pt = "disabled", gt = "show", "dropup", mt = "dropright", _t = "dropleft", vt = "dropdown-menu-right", Et = "position-static", yt = '[data-toggle="dropdown"]', bt = ".dropdown form", Tt = ".dropdown-menu", Ct = ".navbar-nav", wt = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", It = "top-start", Dt = "top-end", At = "bottom-start", St = "bottom-end", Ot = "right-start", Nt = "left-start", kt = { offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic" }, Lt = { offset: "(number|string|function)", flip: "boolean", boundary: "(string|element)", reference: "(string|element)", display: "string" }, Pt = function() {
            ...
            return e.toggle = function() {
                if (!this._element.disabled && !st(this._element).hasClass(pt)) {
                    ...
                    if (t._clearMenus(), !i) {
                        ...
                        if (st(e).trigger(o), !o.isDefaultPrevented()) { if (!this._inNavbar) { if (void 0 === n) throw new TypeError("Bootstrap dropdown require Popper.js (https://popper.js.org)"); var s = this._element; "parent" === this._config.reference ? s = e : rn.isElement(this._config.reference) && (s = this._config.reference, void 0 !== this._config.reference.jquery && (s = this._config.reference[0])), "scrollParent" !== this._config.boundary && st(e).addClass(Et), this._popper = new n(s, this._menu, this._getPopperConfig()) } "ontouchstart" in document.documentElement && 0 === st(e).closest(Ct).length && st(document.body).children().on("mouseover", null, st.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), st(this._menu).toggleClass(gt), st(e).toggleClass(gt).trigger(st.Event(dt.SHOWN, r)) }
                    }
                }
            }, e.dispose = function() { st.removeData(this._element, lt), st(this._element).off(ct), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null) }, e.update = function() { this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate() }, e._addEventListeners = function() {
                var t = this;
                st(this._element).on(dt.CLICK, function(e) { e.preventDefault(), e.stopPropagation(), t.toggle() })
            }, e._getConfig = function(t) { return t = o({}, this.constructor.Default, st(this._element).data(), t), rn.typeCheckConfig(at, t, this.constructor.DefaultType), t }, e._getMenuElement = function() {
                if (!this._menu) {
                    var e = t._getParentFromElement(this._element);
            ...
            }, e._detectNavbar = function() { return 0 < st(this._element).closest(".navbar").length }, e._getPopperConfig = function() {
                var t = this,
                    e = {};
            ...
            }, t._getParentFromElement = function(t) { var e, n = rn.getSelectorFromElement(t); return n && (e = st(n)[0]), e || t.parentNode }, t._dataApiKeydownHandler = function(e) {
            ...
            }, r(t, null, [{ key: "VERSION", get: function() { return "4.1.1" } }, { key: "Default", get: function() { return kt } }, { key: "DefaultType", get: function() { return Lt } }]), t
        }(), st(document).on(dt.KEYDOWN_DATA_API, yt, Pt._dataApiKeydownHandler).on(dt.KEYDOWN_DATA_API, Tt, Pt._dataApiKeydownHandler).on(dt.CLICK_DATA_API + " " + dt.KEYUP_DATA_API, Pt._clearMenus).on(dt.CLICK_DATA_API, yt, function(t) { t.preventDefault(), t.stopPropagation(), Pt._jQueryInterface.call(st(this), "toggle") }).on(dt.CLICK_DATA_API, bt, function(t) { t.stopPropagation() }), st.fn[at] = Pt._jQueryInterface, st.fn[at].Constructor = Pt, st.fn[at].noConflict = function() { return st.fn[at] = ft, Pt._jQueryInterface }, Pt),
        hn = (jt = "modal", Ht = "." + (Rt = "bs.modal"), Ft = (xt = e).fn[jt], Wt = { backdrop: !0, keyboard: !0, focus: !0, show: !0 }, Mt = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean" }, Ut = { HIDE: "hide" + Ht, HIDDEN: "hidden" + Ht, SHOW: "show" + Ht, SHOWN: "shown" + Ht, FOCUSIN: "focusin" + Ht, RESIZE: "resize" + Ht, CLICK_DISMISS: "click.dismiss" + Ht, KEYDOWN_DISMISS: "keydown.dismiss" + Ht, MOUSEUP_DISMISS: "mouseup.dismiss" + Ht, MOUSEDOWN_DISMISS: "mousedown.dismiss" + Ht, CLICK_DATA_API: "click" + Ht + ".data-api" }, Bt = "modal-scrollbar-measure", Kt = "modal-backdrop", Vt = "modal-open", Qt = "fade", Yt = "show", Gt = { DIALOG: ".modal-dialog", DATA_TOGGLE: '[data-toggle="modal"]', DATA_DISMISS: '[data-dismiss="modal"]', FIXED_CONTENT: ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", STICKY_CONTENT: ".sticky-top", NAVBAR_TOGGLER: ".navbar-toggler" }, qt = function() {
            function t(t, e) { this._config = this._getConfig(e), this._element = t, this._dialog = xt(t).find(Gt.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._scrollbarWidth = 0 }
            var e = t.prototype;
            return e.toggle = function(t) { return this._isShown ? this.hide() : this.show(t) }, e.show = function(t) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    ...
                    xt(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), xt(document.body).addClass(Vt), this._setEscapeEvent(), this._setResizeEvent(), xt(this._element).on(Ut.CLICK_DISMISS, Gt.DATA_DISMISS, function(t) { return e.hide(t) }), xt(this._dialog).on(Ut.MOUSEDOWN_DISMISS, function() { xt(e._element).one(Ut.MOUSEUP_DISMISS, function(t) { xt(t.target).is(e._element) && (e._ignoreBackdropClick = !0) }) }), this._showBackdrop(function() { return e._showElement(t) }))
                }
            }, e.hide = function(t) {
                var e = this;
                if (t && t.preventDefault(), !this._isTransitioning && this._isShown) {
                    ...
                    if (xt(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        ...
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), xt(document).off(Ut.FOCUSIN), xt(this._element).removeClass(Yt), xt(this._element).off(Ut.CLICK_DISMISS), xt(this._dialog).off(Ut.MOUSEDOWN_DISMISS), i) {
                            ...
                            xt(this._element).one(rn.TRANSITION_END, function(t) { return e._hideModal(t) }).emulateTransitionEnd(r)
                        } else this._hideModal()
                    }
                }
            }, e.dispose = function() { xt.removeData(this._element, Rt), xt(window, document, this._element, this._backdrop).off(Ht), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null }, e.handleUpdate = function() { this._adjustDialog() }, e._getConfig = function(t) { return t = o({}, Wt, t), rn.typeCheckConfig(jt, t, Mt), t }, e._showElement = function(t) {
                var e = this,
                ...
                var i = xt.Event(Ut.SHOWN, { relatedTarget: t }),
                    r = function() { e._config.focus && e._element.focus(), e._isTransitioning = !1, xt(e._element).trigger(i) };
                if (n) {
                ...
                var t = this;
                xt(document).off(Ut.FOCUSIN).on(Ut.FOCUSIN, function(e) { document !== e.target && t._element !== e.target && 0 === xt(t._element).has(e.target).length && t._element.focus() })
            }, e._setEscapeEvent = function() {
                var t = this;
                this._isShown && this._config.keyboard ? xt(this._element).on(Ut.KEYDOWN_DISMISS, function(e) { 27 === e.which && (e.preventDefault(), t.hide()) }) : this._isShown || xt(this._element).off(Ut.KEYDOWN_DISMISS)
            }, e._setResizeEvent = function() {
                var t = this;
                this._isShown ? xt(window).on(Ut.RESIZE, function(e) { return t.handleUpdate(e) }) : xt(window).off(Ut.RESIZE)
            }, e._hideModal = function() {
                var t = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._isTransitioning = !1, this._showBackdrop(function() { xt(document.body).removeClass(Vt), t._resetAdjustments(), t._resetScrollbar(), xt(t._element).trigger(Ut.HIDDEN) })
            }, e._removeBackdrop = function() { this._backdrop && (xt(this._backdrop).remove(), this._backdrop = null) }, e._showBackdrop = function(t) {
                var e = this,
                    n = xt(this._element).hasClass(Qt) ? Qt : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = Kt, n && xt(this._backdrop).addClass(n), xt(this._backdrop).appendTo(document.body), xt(this._element).on(Ut.CLICK_DISMISS, function(t) { e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide()) }), n && rn.reflow(this._backdrop), xt(this._backdrop).addClass(Yt), !t) return;
                    if (!n) return void t();
            ...
            }, r(t, null, [{ key: "VERSION", get: function() { return "4.1.1" } }, { key: "Default", get: function() { return Wt } }]), t
        ...
        fn = (Xt = "tooltip", Zt = "." + (Jt = "bs.tooltip"), $t = (zt = e).fn[Xt], te = "bs-tooltip", ee = new RegExp("(^|\\s)" + te + "\\S+", "g"), re = { animation: !0, template: '<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !(ie = { AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left" }), selector: !(ne = { animation: "boolean", template: "string", title: "(string|element|function)", trigger: "string", delay: "(number|object)", html: "boolean", selector: "(string|boolean)", placement: "(string|function)", offset: "(number|string)", container: "(string|element|boolean)", fallbackPlacement: "(string|array)", boundary: "(string|element)" }), placement: "top", offset: 0, container: !1, fallbackPlacement: "flip", boundary: "scrollParent" }, se = "out", ae = { HIDE: "hide" + Zt, HIDDEN: "hidden" + Zt, SHOW: (oe = "show") + Zt, SHOWN: "shown" + Zt, INSERTED: "inserted" + Zt, CLICK: "click" + Zt, FOCUSIN: "focusin" + Zt, FOCUSOUT: "focusout" + Zt, MOUSEENTER: "mouseenter" + Zt, MOUSELEAVE: "mouseleave" + Zt }, le = "fade", ce = "show", he = ".tooltip-inner", ".arrow", fe = "hover", ue = "focus", "click", "manual", de = function() {
            ...
            return e.enable = function() { this._isEnabled = !0 }, e.disable = function() { this._isEnabled = !1 }, e.toggleEnabled = function() { this._isEnabled = !this._isEnabled }, e.toggle = function(t) {
            ...
            }, e.dispose = function() { clearTimeout(this._timeout), zt.removeData(this.element, this.constructor.DATA_KEY), zt(this.element).off(this.constructor.EVENT_KEY), zt(this.element).closest(".modal").off("hide.bs.modal"), this.tip && zt(this.tip).remove(), this._isEnabled = null, this._timeout = null, this._hoverState = null, (this._activeTrigger = null) !== this._popper && this._popper.destroy(), this._popper = null, this.element = null, this.config = null, this.tip = null }, e.show = function() {
                var t = this;
                ...
                var e = this,
                    ...
                    r = function() { e._hoverState !== oe && n.parentNode && n.parentNode.removeChild(n), e._cleanTipClass(), e.element.removeAttribute("aria-describedby"), zt(e.element).trigger(e.constructor.Event.HIDDEN), null !== e._popper && e._popper.destroy(), t && t() };
            ...
            }, e.update = function() { null !== this._popper && this._popper.scheduleUpdate() }, e.isWithContent = function() { return Boolean(this.getTitle()) }, e.addAttachmentClass = function(t) { zt(this.getTipElement()).addClass(te + "-" + t) }, e.getTipElement = function() { return this.tip = this.tip || zt(this.config.template)[0], this.tip }, e.setContent = function() {
                var t = zt(this.getTipElement());
                this.setElementContent(t.find(he), this.getTitle()), t.removeClass(le + " " + ce)
            }, e.setElementContent = function(t, e) { var n = this.config.php; "object" == typeof e && (e.nodeType || e.jquery) ? n ? zt(e).parent().is(t) || t.empty().append(e) : t.text(zt(e).text()) : t[n ? "html" : "text"](e) }, e.getTitle = function() { var t = this.element.getAttribute("data-original-title"); return t || (t = "function" == typeof this.config.title ? this.config.title.call(this.element) : this.config.title), t }, e._getAttachment = function(t) { return ie[t.toUpperCase()] }, e._setListeners = function() {
                var t = this;
                this.config.trigger.split(" ").forEach(function(e) {
                    if ("click" === e) zt(t.element).on(t.constructor.Event.CLICK, t.config.selector, function(e) { return t.toggle(e) });
                    else if ("manual" !== e) {
                        ...
                        zt(t.element).on(n, t.config.selector, function(e) { return t._enter(e) }).on(i, t.config.selector, function(e) { return t._leave(e) })
                    }
                    zt(t.element).closest(".modal").on("hide.bs.modal", function() { return t.hide() })
            ...
            }, r(t, null, [{ key: "VERSION", get: function() { return "4.1.1" } }, { key: "Default", get: function() { return re } }, { key: "NAME", get: function() { return Xt } }, { key: "DATA_KEY", get: function() { return Jt } }, { key: "Event", get: function() { return ae } }, { key: "EVENT_KEY", get: function() { return Zt } }, { key: "DefaultType", get: function() { return ne } }]), t
        }(), zt.fn[Xt] = de._jQueryInterface, zt.fn[Xt].Constructor = de, zt.fn[Xt].noConflict = function() { return zt.fn[Xt] = $t, de._jQueryInterface }, de),
        un = (ge = "popover", _e = "." + (me = "bs.popover"), ve = (pe = e).fn[ge], Ee = "bs-popover", ye = new RegExp("(^|\\s)" + Ee + "\\S+", "g"), be = o({}, fn.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }), Te = o({}, fn.DefaultType, { content: "(string|element|function)" }), "fade", Ce = ".popover-header", we = ".popover-body", Ie = { HIDE: "hide" + _e, HIDDEN: "hidden" + _e, SHOW: "show" + _e, SHOWN: "shown" + _e, INSERTED: "inserted" + _e, CLICK: "click" + _e, FOCUSIN: "focusin" + _e, FOCUSOUT: "focusout" + _e, MOUSEENTER: "mouseenter" + _e, MOUSELEAVE: "mouseleave" + _e }, De = function(t) {
            var e, n;

            function i() { return t.apply(this, arguments) || this }
            n = t, (e = i).prototype = Object.create(n.prototype), (e.prototype.constructor = e).__proto__ = n;
            var o = i.prototype;
            return o.isWithContent = function() { return this.getTitle() || this._getContent() }, o.addAttachmentClass = function(t) { pe(this.getTipElement()).addClass(Ee + "-" + t) }, o.getTipElement = function() { return this.tip = this.tip || pe(this.config.template)[0], this.tip }, o.setContent = function() {
            ...
            }, r(i, null, [{ key: "VERSION", get: function() { return "4.1.1" } }, { key: "Default", get: function() { return be } }, { key: "NAME", get: function() { return ge } }, { key: "DATA_KEY", get: function() { return me } }, { key: "Event", get: function() { return Ie } }, { key: "EVENT_KEY", get: function() { return _e } }, { key: "DefaultType", get: function() { return Te } }]), i
        }(fn), pe.fn[ge] = De._jQueryInterface, pe.fn[ge].Constructor = De, pe.fn[ge].noConflict = function() { return pe.fn[ge] = ve, De._jQueryInterface }, De),
        dn = (Se = "scrollspy", Ne = "." + (Oe = "bs.scrollspy"), ke = (Ae = e).fn[Se], Le = { offset: 10, method: "auto", target: "" }, Pe = { offset: "number", method: "string", target: "(string|element)" }, xe = { ACTIVATE: "activate" + Ne, SCROLL: "scroll" + Ne, LOAD_DATA_API: "load" + Ne + ".data-api" }, je = "dropdown-item", Re = "active", He = { DATA_SPY: '[data-spy="scroll"]', ACTIVE: ".active", NAV_LIST_GROUP: ".nav, .list-group", NAV_LINKS: ".nav-link", NAV_ITEMS: ".nav-item", LIST_ITEMS: ".list-group-item", DROPDOWN: ".dropdown", DROPDOWN_ITEMS: ".dropdown-item", DROPDOWN_TOGGLE: ".dropdown-toggle" }, "offset", Fe = "position", We = function() {
            function t(t, e) {
                var n = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + He.NAV_LINKS + "," + this._config.target + " " + He.LIST_ITEMS + "," + this._config.target + " " + He.DROPDOWN_ITEMS, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, Ae(this._scrollElement).on(xe.SCROLL, function(t) { return n._process(t) }), this.refresh(), this._process()
            }
            var e = t.prototype;
            ...
            }, e.dispose = function() { Ae.removeData(this._element, Oe), Ae(this._scrollElement).off(Ne), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null }, e._getConfig = function(t) {
            ...
            }, e._clear = function() { Ae(this._selector).filter(He.ACTIVE).removeClass(Re) }, t._jQueryInterface = function(e) {
                return this.each(function() {
            ...
            }, r(t, null, [{ key: "VERSION", get: function() { return "4.1.1" } }, { key: "Default", get: function() { return Le } }]), t
        ...
        }), Ae.fn[Se] = We._jQueryInterface, Ae.fn[Se].Constructor = We, Ae.fn[Se].noConflict = function() { return Ae.fn[Se] = ke, We._jQueryInterface }, We),
        pn = (Be = "." + (Ue = "bs.tab"), Ke = (Me = e).fn.tab, Ve = { HIDE: "hide" + Be, HIDDEN: "hidden" + Be, SHOW: "show" + Be, SHOWN: "shown" + Be, CLICK_DATA_API: "click" + Be + ".data-api" }, Qe = "dropdown-menu", Ye = "active", Ge = "disabled", "fade", qe = "show", ze = ".dropdown", Xe = ".nav, .list-group", Je = ".active", Ze = "> li > .active", $e = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', tn = ".dropdown-toggle", en = "> .dropdown-menu .active", nn = function() {
            function t(t) { this._element = t }
            var e = t.prototype;
            ...
            }, e.dispose = function() { Me.removeData(this._element, Ue), this._element = null }, e._activate = function(t, e, n) {
                var i = this,
        ...
        }(), Me(document).on(Ve.CLICK_DATA_API, $e, function(t) { t.preventDefault(), nn._jQueryInterface.call(Me(this), "show") }), Me.fn.tab = nn._jQueryInterface, Me.fn.tab.Constructor = nn, Me.fn.tab.noConflict = function() { return Me.fn.tab = Ke, nn._jQueryInterface }, nn);
