@@include('header.htm') @@include('blocks/navigation.htm') @@include('blocks/page-title.htm', {"title": "Our Team"})
...
@@include('blocks/clients-logo-slider.htm') @@include('blocks/footer.htm') @@include('footer.htm')