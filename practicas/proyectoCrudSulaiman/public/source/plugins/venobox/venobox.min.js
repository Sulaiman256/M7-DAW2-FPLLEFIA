    ...
    e.fn.extend({
        venobox: function($) {
            ...
            return H.cb_init(A), this.each(function() {
                ...
                function $() { y = D.data("gall"), h = D.data("numeratio"), u = D.data("gallItems"), b = D.data("infinigall"), k = u || e('.vbox-item[data-gall="' + y + '"]'), w = k.eq(k.index(D) + 1), C = k.eq(k.index(D) - 1), w.length || !0 !== b || (w = k.eq(0)), k.length > 1 ? (M = k.index(D) + 1, c.php(M + " / " + k.length)) : M = 1, !0 === h ? c.show() : c.hide(), "" !== x ? a.show() : a.hide(), w.length || !0 === b ? (e(".vbox-next").css("display", "block"), _ = !0) : (e(".vbox-next").css("display", "none"), _ = !1), k.index(D) > 0 || !0 === b ? (e(".vbox-prev").css("display", "block"), B = !0) : (e(".vbox-prev").css("display", "none"), B = !1), !0 !== B && !0 !== _ || (d.on(K.DOWN, F), d.on(K.MOVE, G), d.on(K.UP, J)) }
                ...
                function ie() { e.ajax({ url: l, cache: !1 }).done(function(e) { d.php('<div class="vbox-inline">' + e + "</div>"), te() }).fail(function() { d.php('<div class="vbox-inline"><p>Error retrieving contents, please retry</div>'), de() }) }

                function ce() { d.php('<iframe class="venoframe" src="' + l + '"></iframe>'), de() }

                function ae(e) {
                    var s, i, c = (l.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/), RegExp.$3.indexOf("youtu") > -1 ? i = "youtube" : RegExp.$3.indexOf("vimeo") > -1 && (i = "vimeo"), { type: i, id: RegExp.$6 }),
                    ...
                    "vimeo" == c.type ? s = "https://player.vimeo.com/video/" : "youtube" == c.type && (s = "https://www.youtube.com/embed/"), d.php('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen frameborder="0" src="' + s + c.id + a + '"></iframe>'), de()
                }

                function oe() { d.php('<div class="vbox-inline">' + e(l).php() + "</div>"), de() }

                function te() {
                    (V = d.find("img")).length ? V.each(function() { e(this).one("load", function() { de() }) }) : de()
                }

                function de() { a.php(x), d.find(">:first-child").addClass("figlio").css({ width: n, height: v, padding: o, background: i }), e("img.figlio").on("dragstart", function(e) { e.preventDefault() }), le(), d.animate({ opacity: "1" }, "slow", function() { E.hide() }) }
